document.write(`
    ...
    <body>
        <header>
            ...
            <div class="user">
                <a href="#">
                    <img src="Assets/Images/marty.png" alt="Student">
                </a>
                <div class="user-content">
                    <h3>Marty McFly</h3>
                    <p>martymcfly.24@um.edu.mt</p>
                    <br><br><h4>STUDENT ACCOUNT</h4>
                    <a href="./studentLogIn.html" class="general-button" id="user-button">
                        <h3>Sign Out</h3>
                    </a>
                </div>
            </div>
